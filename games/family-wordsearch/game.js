...
/*
  Ten family words are hidden horizontally,
  vertically and diagonally.

  Some words run forwards, backwards,
...
ui.text.textContent =
  timedOut
    ? "You found all ten words, but the timer ran out on an earlier attempt. 🥥 Coconut collected!"
    : "You found all ten words in time. 🍹 Cocktail earned!";
...
if (action === "returnFromWordSearch") {
