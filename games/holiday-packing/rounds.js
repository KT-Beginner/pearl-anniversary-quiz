...
},
{
...

  {
    ...
    gameType: "packing",
    title: "Holiday Time — Pack the Suitcase!",
    subtitle: "Help Louise and Steve pack everything they need for their holiday!",
    locationLabel: "HOLIDAY",

    duration: 60,

    packingItems: [
  { name: "passports", symbol: "🛂", correct: true, points: 20 },
  { name: "kitchen sink", symbol: "🚰", correct: false },
  { name: "camera", symbol: "📷", correct: true, points: 15 },
  { name: "sun cream", symbol: "🧴", correct: true, points: 15 },
  { name: "sun hats", symbol: "👒", correct: true, points: 15 },

  { name: "sofa", symbol: "🛋️", correct: false },
  { name: "sandals", symbol: "🩴", correct: true, points: 15 },
  { name: "holiday clothes", symbol: "👕", correct: true, points: 15 },
  { name: "television", symbol: "📺", correct: false },
  { name: "sunglasses", symbol: "🕶️", correct: true, points: 15 },

  { name: "swimwear", symbol: "🩱", correct: true, points: 20 },
  { name: "money", symbol: "👛", correct: true, points: 15 },
  { name: "lawn mower", symbol: "🏡", correct: false },
  { name: "mosquito spray", symbol: "🦟", correct: true, points: 15 },
  { name: "plane tickets", symbol: "🎫", correct: true, points: 20 }
    ...
    intro:
      "Louise and Steve are off on holiday! Help them pack everything they need — and leave the ridiculous extras at home!",

    complete:
      "Suitcase packed! Louise and Steve are ready for their holiday! 🍹"
  },
